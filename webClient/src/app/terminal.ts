...
export class Terminal {
  ...
  constructor(
    ...
    static discoveryServiceWorks = false;
  ...
  connectToHost(connectionSettings: any) {
	  ...
	  console.log("screenLoadedCallback this="+this);
	  console.log("sLC this.virtualScreen = "+(this ? this.virtualScreen : "<NotThere>"));
	  if (Terminal.discoveryServiceWorks){
      ...
      this.virtualScreen = org_zowe_tsterm.TerminalLauncher.start3270({parentDiv:this.terminalElement,
